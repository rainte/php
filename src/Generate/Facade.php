...
namespace Rainte\PHP\Generate;

use Rainte\PHP\Client;
use Rainte\PHP\Services\AbstractService;
...
class Facade
{
    ...
    protected function class(string $key, object $object): string
    {
        ...
        $res[] = ' * @see \\' . $ref->getName();
        $res[] = ' */';
        $res[] = 'class ' . $key . ' extends \Rainte\PHP\Facades\AbstractFacade';
        $res[] = '{';
        $res[] = '    /**';
        $res[] = '     * @inheritdoc';
        $res[] = '     */';
        $res[] = '    protected $class = \Rainte\PHP\Providers\\' . $key . 'Provider::class;';
        $res[] = '}';
        $res[] = '';
